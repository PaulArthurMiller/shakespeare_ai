...
class TranslationManager:
    ...
    def start_translation_session(self, translation_id: Optional[str] = None):
        ...
        self.assembler.logger = CustomLogger("Assembler", log_level="DEBUG", log_file=session_log_file)
    ...
    def translate_line(self, modern_line: str, selector_results: Dict[str, List[CandidateQuote]], 
        ...
        try:
            ...
            try:
                ...
                # Log the raw result from the assembler
                self.logger.debug(f"Assembler raw result: text={assembled_text[:50]}..., temp_ids type={type(temp_ids_used)}, value={temp_ids_used}")
